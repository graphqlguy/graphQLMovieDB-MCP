# graphQLMovieDB-MCP - Class 17

This branch is the repository state at the end of [Class 17: Observability and Deployment](https://graphqlguy.com/docs/tutorial-graphql-mcp/observability-and-deployment), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 17 adds:** `ToolMetricsAspect` and `CostMetrics`, plus the production profile and the logback configuration that ship them.

**Following along:** start from `mcp_class_16`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_18`.
