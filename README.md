# graphQLMovieDB-MCP - Class 10

This branch is the repository state at the end of [Class 10: Streaming, Progress, and Long-Running Tools](https://graphqlguy.com/docs/tutorial-graphql-mcp/streaming-progress-long-running), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 10 adds:** progress notifications on the summarize tool, so a long call reports where it is.

**Following along:** start from `mcp_class_9`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_11`.
