# graphQLMovieDB-MCP - Class 18

This branch is the repository state at the end of [Class 18: Building a Spring AI Agent Client](https://graphqlguy.com/docs/tutorial-graphql-mcp/spring-ai-agent-client), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 18 adds:** the `moviedb-agent/` module: a Spring AI ChatClient that connects to this server over MCP and runs from the command line.

**Following along:** start from `mcp_class_17`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_19`.
