# graphQLMovieDB-MCP - Class 4b

This branch is the repository state at the end of [Class 4b: Dynamic Discovery and the Search / Introspect / Execute Pattern](https://graphqlguy.com/docs/tutorial-graphql-mcp/dynamic-discovery-search-introspect-execute), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 4b adds:** `apollo/mcp-config-dynamic.yaml`, the runnable config for the search, introspect and execute pattern.

**Following along:** start from `mcp_class_4`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_5`.
