# graphQLMovieDB-MCP - Class 3

This branch is the repository state at the end of [Class 3: Schema Descriptions as Agent Documentation](https://graphqlguy.com/docs/tutorial-graphql-mcp/schema-descriptions-as-agent-docs), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 3 adds:** agent-facing descriptions across the schema, and `SchemaDescriptionLintTest`, the gate that keeps them from rotting.

**Following along:** start from `mcp_class_2`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_4`.
