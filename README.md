# graphQLMovieDB-MCP - Class 12

This branch is the repository state at the end of [Class 12: Testing the Spring AI MCP Server](https://graphqlguy.com/docs/tutorial-graphql-mcp/testing), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 12 adds:** the four test levels: unit, the `tools-list.json` contract, a property test over the mood tool, and an integration test against the live MCP endpoint.

**Following along:** start from `mcp_class_11`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_13`.
