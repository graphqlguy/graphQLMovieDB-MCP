# graphQLMovieDB-MCP - Class 9

This branch is the repository state at the end of [Class 9: Structured Outputs and Errors](https://graphqlguy.com/docs/tutorial-graphql-mcp/structured-outputs-and-errors), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 9 adds:** `ToolResults`, which gives every tool a structured result and turns failures into typed errors an agent can act on.

**Following along:** start from `mcp_class_8`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_10`.
