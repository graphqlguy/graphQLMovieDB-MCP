# graphQLMovieDB-MCP - Class 6

This branch is the repository state at the end of [Class 6: Spring AI MCP Server Starter, the Spring-Native Path](https://graphqlguy.com/docs/tutorial-graphql-mcp/spring-ai-mcp-server-starter), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 6 adds:** the Spring AI MCP server starter, a `HelloMcpTool` to prove the wiring, and the `application.yaml` block that serves MCP at `:8080/mcp`.

**Following along:** start from `mcp_class_5`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_7`.
