# graphQLMovieDB-MCP - Class 5

This branch is the repository state at the end of [Class 5: Apollo in Practice and Its Limits](https://graphqlguy.com/docs/tutorial-graphql-mcp/apollo-in-practice), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 5 adds:** `apollo/mcp-config.yaml` and its support variant, the `add_to_watchlist` operation, and tool output schemas turned on.

**Following along:** start from `mcp_class_4b`, work through the lesson, then compare your result with this branch. The next class continues on `mcp_class_6`.
