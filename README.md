# graphQLMovieDB-MCP - Class 19

This branch is the repository state at the end of [Class 19: Plugging Into Claude Desktop via stdio](https://graphqlguy.com/docs/tutorial-graphql-mcp/claude-desktop-via-stdio), part of the [GraphQL + MCP course](https://graphqlguy.com/docs/tutorial-graphql-mcp/mcp-and-graphql).

**What Class 19 adds:** the stdio profile, `StdioSecurityConfig`, a stdio logback configuration, and `bin/moviedb-mcp-stdio.sh`, the launcher Claude Desktop starts.

**Following along:** start from `mcp_class_18`, work through the lesson, then compare your result with this branch. This is the last branch; [Class 20](https://graphqlguy.com/docs/tutorial-graphql-mcp/beyond-tool-enumeration) is a code-free epilogue that reads against it.
